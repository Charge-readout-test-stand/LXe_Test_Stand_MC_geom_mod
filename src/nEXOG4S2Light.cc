...
//
//
// Noble Element Simulation Technique "nEXOG4S2Light" physics process
//
////////////////////////////////////////////////////////////////////////
// S2 Scintillation Light Class Implementation
////////////////////////////////////////////////////////////////////////
//
// File:        nEXOG4S2Light.cc (companion of nEXOG4S1Light.cc)
...
nEXOG4S2Light::nEXOG4S2Light(const G4String& processName, 
		           G4ProcessType type)
...
nEXOG4S2Light::~nEXOG4S2Light(){} //destructor

G4VParticleChange*
nEXOG4S2Light::AtRestDoIt(const G4Track& aTrack, const G4Step& aStep)
{
  return nEXOG4S2Light::PostStepDoIt(aTrack, aStep);
}

G4VParticleChange*
nEXOG4S2Light::PostStepDoIt(const G4Track& aTrack, const G4Step& aStep)
{
...
// is but an alpha version of the electroluminescence code
 ...
 GetConstProperty("ELECTRICFIELDSURFACE")/(volt/cm)),MillerDriftSpeed,z1));
	...
	if ( verboseLevel > 0 ) {
	  G4cout << "\n Exiting from nEXOG4S2Light::DoIt -- "
		 << "NumberOfSecondaries = "
...
// GetMeanFreePath
// ---------------
G4double nEXOG4S2Light::GetMeanFreePath(const G4Track& aTrack,
                                          G4double ,
...
// GetMeanLifeTime
// ---------------
G4double nEXOG4S2Light::GetMeanLifeTime(const G4Track&,
                                          G4ForceCondition* condition)
{

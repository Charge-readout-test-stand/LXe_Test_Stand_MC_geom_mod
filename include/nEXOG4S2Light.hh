#ifndef nEXOG4S2Light_h
#define nEXOG4S2Light_h 1
...
class nEXOG4S2Light : public G4VRestDiscreteProcess //class definition
{
...
public: // constructor and destructor
        ...
        nEXOG4S2Light(const G4String& processName = "S2",
...
inline 
G4bool nEXOG4S2Light::IsApplicable(const G4ParticleDefinition& aParticleType)
{
...
inline 
void nEXOG4S2Light::SetTrackSecondariesFirst(const G4bool state) 
{ 
	fTrackSecondariesFirst = state;
}

inline
G4bool nEXOG4S2Light::GetTrackSecondariesFirst() const
{
        return fTrackSecondariesFirst;
}

inline
void nEXOG4S2Light::SetScintillationYieldFactor(const G4double yieldfactor)
{
  YieldFactor = yieldfactor;
}

inline
G4double nEXOG4S2Light::GetScintillationYieldFactor() const
{
        return YieldFactor;
}

inline
void nEXOG4S2Light::SetScintillationExcitationRatio(const G4double excitationratio)
{
        ExcitationRatio = excitationratio;
}

inline
G4double nEXOG4S2Light::GetScintillationExcitationRatio() const
{
        return ExcitationRatio;
}

#endif /* nEXOG4S2Light_h */
